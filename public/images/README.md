...
2. Перейдите в папку: `english-tutor-website/public/images/`
3. Перетащите ваше фото в эту папку
4. **ВАЖНО:** Переименуйте файл в **`artur-photo.jpeg`** (точное имя)
...
- **Имя файла:** `artur-photo.jpeg` (точно!)
- **Формат:** JPG или JPEG
...
3. Вместо круга с инициалами "ЕА" будет ваша фотография

---

**Текущий статус:** Фото НЕ загружено (показываются инициалы ЕА)
